...
/**
 * Interface for listening for a {@link MonthChangeEvent} fired by a {@link TuningDateField}.
 * 
 * @author Frederic.Dreyfus
 */
public interface MonthChangeListener extends Serializable {

    /**
     * Called when the month a {@link TuningDateField} calendar has been changed.
     * 
     * @param event
     *            An event containing the new {@link YearMonth} of the calendar.
     */
