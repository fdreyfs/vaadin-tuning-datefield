...
/**
 * Interface for listening for a {@link CalendarOpenEvent} fired by a {@link TuningDateField}.
 * 
 * @author Frederic.Dreyfus
 */
public interface CalendarOpenListener extends Serializable {

    /**
     * Called when the {@link TuningDateField} calendar is open.
     * 
     * @param event
     *            the event
     */
